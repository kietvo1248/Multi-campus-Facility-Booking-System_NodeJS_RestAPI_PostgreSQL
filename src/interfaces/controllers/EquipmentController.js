class EquipmentController {
  ...
  async listFacilityEquipment(req, res) { try { const data = await this.facilityEquipmentService.listByFacility(Number(req.params.facilityId)); res.status(200).json(data) } catch (e) { res.status(500).json({ message: e.message }) } }
