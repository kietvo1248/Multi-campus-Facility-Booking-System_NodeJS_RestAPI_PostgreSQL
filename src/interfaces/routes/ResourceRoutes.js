...
const createResourceRouter = (controller) => {
  ...
  router.get('/campuses', authenticate, authorize(['FACILITY_ADMIN','CAMPUS_ADMIN', 'STUDENT', 'LECTURER']), (req, res) => controller.listCampuses(req, res))
  ...
  router.get('/facility-types', authenticate, authorize(['FACILITY_ADMIN','CAMPUS_ADMIN', 'STUDENT', 'LECTURER']), (req, res) => controller.listFacilityTypes(req, res))
  ...
  router.get('/clubs', authenticate, authorize(['FACILITY_ADMIN','CAMPUS_ADMIN', 'STUDENT', 'LECTURER']), (req, res) => controller.listClubs(req, res))
  ...
  router.get('/clubs/:id/priorities', authenticate, authorize(['FACILITY_ADMIN','CAMPUS_ADMIN', 'STUDENT', 'LECTURER']), (req, res) => controller.listClubPriorities(req, res))
